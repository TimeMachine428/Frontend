        ...
        return (
            <div>
                <form>
                    ...
                    <p><input type="text" name="title" onChange={this.handleChange}/></p>
                    <p>Enter the problem type below</p>
                    <p><input type="text" name="type" onChange={this.handleChange}/></p>
                    <p>Enter the estimated difficulty level on a scale from 1-5</p>
                    <p><input type="text" name="difficulty" onChange={this.handleChange}/></p>
                    <p>Enter your problem in the box below</p>
                    <p><Textarea name="description" style={{width: 300, height: 300}} onChange={this.handleChange}/></p>
